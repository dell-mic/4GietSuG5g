...
/**
 * @author Michi Bildet ein Vier-Gewinnt-Spiel mit mehreren Saetzen ab
 */
public class FourInARowGame implements Observer {
	 ...
	 * @param commDirString
	 *            Die Pfadangabe, unter der mit dem Server kommuniziert werden
	 *            soll
	 */
	...
	public String getScore() {
		return "0:0"; // TODO Spielstand nach Saetzen ermitteln und als String
						// zurückliefern
	}
	...
	public void setCommDir(String commDirString) {
		...
		if (commDir.canWrite())
			Debug.log(2, "Kommunikationspfad erfolgreich eingerichtet.");
		else
	...
	public void update(Observable arg0, Object arg1) {
		...
		if (arg1 != null && arg1 instanceof ServerResponse) {
			...
			if (serverResponse.getFreigabe()) {
				...
				Field calculatedField = ki.calcField(ourPlayer, this
						.getCurrentSet().getBoard());
			...
			if ((winner = this.getCurrentSet().getBoard().findWinner()) != null) {
				Debug.log(0, "Satz #" + (setIndex + 1) + " wurde von Spieler "
						+ winner + " gewonnen!");
				this.endSet();
			}
